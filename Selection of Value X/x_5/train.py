...
if __name__ == '__main__':
    ...
    for k in x:
        ...
        x_3, y_3, x_3_t, y_3_t = load_dataset(k, 0, 3000)
        x_4, y_4, x_4_t, y_4_t = load_dataset(k, 0, 4000)
        train_model(x_0, y_0, x_0_t, y_0_t, 0)
        train_model(x_1, y_1, x_1_t, y_1_t, 1)
        train_model(x_2, y_2, x_2_t, y_2_t, 2)
        train_model(x_3, y_3, x_3_t, y_3_t, 3)
        train_model(x_4, y_4, x_4_t, y_4_t, 4)
        model_l = load()
        for e in range(epoch):
            ...
            # model_next_3 = train_next(x_3, y_3, x_3_t, y_3_t, model_a)
            # model_next_4 = train_next(x_4, y_4, x_4_t, y_4_t, model_a)
            g_n, g_n_list = get_input(model_next_0)
            path_1 = f"list"
            path_2 = f"num"
            save_data(path_1, g_a_list, g_n_list, k)
            save_data(path_2, g_a, g_n, k)
            # model_l = [model_next_0, model_next_1, model_next_2, model_next_3, model_next_4]
